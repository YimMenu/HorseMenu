...
namespace YimMenu::Hooks
{
	...
	namespace Protections
	{
		...
		extern bool SerializeServerRPC(ServerRPCSerializer* ser, void* a2, const char* message, void* def, void* structure, const char* rpc_guid, void* a7);
		extern bool ReceiveServerMessage(void* a1, ServerMsg* a2); // doesn't receive all messages
	}
