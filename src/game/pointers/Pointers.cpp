...
namespace YimMenu
{
	...
	bool Pointers::Init()
	{
		...
		constexpr auto namePtrn = Pattern<"72 ? 78 ? 6E 6E 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 00 00 00 00 F8">("Username");
		scanner.Add(namePtrn, [this](PointerCalculator ptr) {
			Username = ptr.As<char*>();
		});
