...
namespace YimMenu
{
	void NotificationService::ShowNotification(std::string title, std::string message, NotificationType type, int duration, std::function<void()> context_function, std::string context_function_name)
	{
